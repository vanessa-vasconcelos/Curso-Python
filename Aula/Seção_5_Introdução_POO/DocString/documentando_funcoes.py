...
variavel_4 = 4
changes: 3 
# import uma_linha	# import uma_linha
import varias_linhas	# import varias_linhas
import documentando_funcoes


# print(dir(uma_linha))	# print(dir(uma_linha))
# print(uma_linha.__doc__)	# print(uma_linha.__doc__)
# print(uma_linha.__file__)	# print(uma_linha.__file__)
# print(uma_linha.__name__)	# print(uma_linha.__name__)
help(varias_linhas)	

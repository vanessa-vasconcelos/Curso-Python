...
CAMINHO_HTML = pathlib.Path(__file__).parent / 'smtp_email.html'

# Ddaos do remetente e destinatário
...
#Mensagem de texto
with open(CAMINHO_HTML, 'r', encoding='utf-8-sig') as arquivo:
...
corpo_email = MIMEText(texto_email, 'html', 'utf-8-sig')

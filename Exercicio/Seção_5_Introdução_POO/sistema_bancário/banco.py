...
class Banco:
  ...
  def autenticar(self, cliente: pessoas.Pessoa, conta: contas.Conta):
    return self._checa_agencia(conta) and self._checa_cliente(cliente) and \
      self._checa_conta(conta) and self._checa_se_conta_e_do_cliente(cliente,conta)
...
if __name__ == '__main__':
  c1 = pessoas.Cliente('Vanessa', 22)
  cc1 = contas.ContaCorrente(111, 222, 0, 0)
  c1.conta = cc1
  c2 = pessoas.Cliente('Fátima', 53)
